...
export const metadata: Metadata = {
  title: "Barndo Insurance Business Insurance Blog",
  description: `Guides on GL, workers comp, completed operations, and surety bonds for barndo businesses. Expert advice from ${SITE.name}.`,
};
      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Barndo Insurance Insurance Blog</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Expert guides on insurance for wood and steel barndo businesses.
              </p>
            </FadeIn>
          </div>
        </section>
