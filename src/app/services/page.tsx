...
export const metadata: Metadata = {
  title: "Barndo Insurance Business Insurance Services",
  description: `Complete insurance coverage for barndo businesses — GL, workers comp, tools & equipment, commercial auto, completed operations, surety bonds, and umbrella. ${SITE.statesLicensed}.`,
};
        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Barndo Insurance Business Insurance</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Every policy a barndo business needs — in one place, from specialists who know the trade.
              </p>
            </FadeIn>
          </div>
        </section>
